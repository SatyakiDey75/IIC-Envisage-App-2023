                              ...
                              child: GestureDetector(
                                onTap: () {
                                  final Uri _url = Uri.parse(
                                      "https://drive.google.com/file/d/1Kip9kouSZtSc27D06O7s7ffPTB_QGBYk/view?usp=share_link");
                                  launchUrl(_url);
                                },
                                child: Row(
                                  children: [
                ...
                child: Row(
                  ...
                  children: [
                    TextButton(
                        onPressed: () {
                          final Uri _url = Uri.parse(
                              "https://www.envisage.org.in/legal/terms");
                          launchUrl(_url);
                        },
                        child: Text(
                          "Terms & Conditions",
                    ...
                    TextButton(
                        onPressed: () {
                          final Uri _url = Uri.parse(
                              "https://www.envisage.org.in/legal/privacy");
                          launchUrl(_url);
                        },
                        child: Text(
                          "Privacy Policy",
                    ...
                    TextButton(
                        onPressed: () {
                          final Uri _url = Uri.parse(
                              "https://www.envisage.org.in/legal/refund");
                          launchUrl(_url);
                        },
                        child: Text(
                          "Refund policy",
