...
// MIr4H6uK6tebUGCpIYMGIHdp
              ...
              children: [
                SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      Image.asset("assets/Events/Envisage 23 fb Cover.png"),
                      Padding(
        ...
        onTap: () async {
          ...
          if (_event.id == "biz_debate") {
            final Uri _url = Uri.parse(
                "https://unstop.com/p/tweeters-envisage-23-techno-main-salt-lake-kolkata-west-bengal-671253");
            launchUrl(_url, mode: LaunchMode.externalApplication);
          }
          if (_event.id == "biz_plan") {
            final Uri _url = Uri.parse(
                "https://unstop.com/competitions/b-plan-competition-envisage-23-techno-main-salt-lake-kolkata-west-bengal-671241");
            launchUrl(_url, mode: LaunchMode.externalApplication);
          }
          if (_event.id == "brain") {
            final Uri _url = Uri.parse(
                "https://unstop.com/quiz/brain-it-out-envisage-23-techno-main-salt-lake-kolkata-west-bengal-671248");
            launchUrl(_url, mode: LaunchMode.externalApplication);
          }
          if (_event.id == "case_study") {
            final Uri _url = Uri.parse(
                "https://unstop.com/competitions/case-study-challenge-envisage-23-techno-main-salt-lake-kolkata-west-bengal-669738");
            launchUrl(_url, mode: LaunchMode.externalApplication);
          }
          if (_event.id == "onboard") {
            final Uri _url = Uri.parse(
                "https://unstop.com/events/on-board-envisage-23-techno-main-salt-lake-kolkata-west-bengal-669641");
            launchUrl(_url, mode: LaunchMode.externalApplication);
          }
          if (_event.id == "prototype") {
            final Uri _url = Uri.parse(
                "https://unstop.com/competitions/prototype-design-envisage-23-techno-main-salt-lake-kolkata-west-bengal-671233");
            launchUrl(_url, mode: LaunchMode.externalApplication);
          }
          if (_event.id == "shortfilm") {
            final Uri _url = Uri.parse(
                "https://unstop.com/events/techno-showtime-envisage-23-techno-main-salt-lake-kolkata-west-bengal-670118");
            launchUrl(_url, mode: LaunchMode.externalApplication);
          }
          if (_event.id == "hackathon") {
            final Uri _url = Uri.parse(
                "https://unstop.com/hackathons/hack-ur-way-envisage-23-techno-main-salt-lake-kolkata-west-bengal-671235");
            launchUrl(_url, mode: LaunchMode.externalApplication);
          }
          if (_event.id == "mock_ipl") {
            final Uri _url = Uri.parse(
                "https://unstop.com/events/mock-ipl-auction-envisage-23-techno-main-salt-lake-kolkata-west-bengal-670146");
            launchUrl(_url, mode: LaunchMode.externalApplication);
          }
          if (_event.id == "promote_it") {
            final Uri _url = Uri.parse(
                "https://unstop.com/events/promote-it-envisage-23-techno-main-salt-lake-kolkata-west-bengal-671232");
            launchUrl(_url, mode: LaunchMode.externalApplication);
          }
          if (_event.id == "stockify") {
            final Uri _url = Uri.parse(
                "https://unstop.com/p/stockify-envisage-23-techno-main-salt-lake-kolkata-west-bengal-671252");
            launchUrl(_url, mode: LaunchMode.externalApplication);
          }
        },
        child: Container(
  ...
  Container OrganizerDetailWidget(
      double _width, IconData _iconData, String _name, String _number) {
    return Container(
      padding: EdgeInsets.symmetric(
        horizontal: _width * 0.077,
      ),
